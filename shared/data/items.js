export const ITEM_DEFINITIONS = {
  ...
  tinh_than_dan: {
    id: 'tinh_than_dan',
    name: 'Tĩnh Thần Đan',
    description: 'Giảm 20 điểm Tâm Ma, giúp tâm hồn thanh tĩnh.',
    type: 'pill',
    rarity: 'rare',
  ...
  cuong_hoa_thach: {
    ...
    description: 'Đá dùng để cường hóa trang bị.',
    type: 'material',
    rarity: 'rare',
    price: 500,
  ...
  ngoc_boi: {
    id: 'ngoc_boi',
    name: 'Ngọc Bội',
    description: 'Trang sức quý hiếm, tăng 10% EXP tu luyện.',
    type: 'equipment',
    slot: 'vip',
    rarity: 'rare',
  ...
  tu_ha_bi_dien: {
    id: 'tu_ha_bi_dien',
    name: 'Tử Hà Bí Điển',
    description: 'Công pháp thượng cổ, tăng tốc độ tu luyện vĩnh viễn 10%.',
    type: 'book',
    rarity: 'epic',
    effect: { cultivationSpeed: 0.1 },
    price: 5000,
  ...
  kim_cuong_cuong_than_quyet: {
    ...
    description: 'Thể thuật cường hóa, tăng 20 phòng thủ vĩnh viễn.',
    type: 'book',
    rarity: 'rare',
    effect: { defense: 20 },
    price: 3000,
