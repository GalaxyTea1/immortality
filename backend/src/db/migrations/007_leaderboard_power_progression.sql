-- Combat power should respect realm progression.
-- A higher realm starts above the previous realm's final floor, while stats and
-- equipment still contribute as a visible bonus.
