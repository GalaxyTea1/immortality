                ...
                <div className='hero-content'>
                    <div className='hero-text'>
                        ...
                        <p className='hero-description'>
                            Hòa mình vào thế giới tu tiên huyền ảo, nơi bạn có thể luyện khí, trúc cơ, kết đan và trở thành bậc chí tôn trong thiên
                            hạ. Con đường đại đạo đang chờ người hữu duyên.
                        </p>
                ...
                <div className='features-container'>
                    <div className='section-header'>
                        ...
                        <p className='section-description'>
                            Trải qua muôn vàn kiếp nạn, từ một phàm nhân bình thường bước chân vào con đường tu đạo, nghịch thiên cải mệnh để đắc đạo
                            thành tiên.
                        </p>
                    </div>
                    ...
                    <div className='features-grid'>
                        <div className='feature-card'>
                            ...
                            <p className='feature-description'>
                                Hấp thụ linh khí đất trời, tẩy kinh phạt tủy. Xây dựng nền móng tu đạo vững chắc thông qua việc thiền định hàng ngày.
                            </p>
                        </div>
                        ...
                        <div className='feature-card'>
                            ...
                            <p className='feature-description'>
                                Thu thập thảo dược quý hiếm từ bí cảnh, rèn đúc thần binh lợi khí để gia tăng sức mạnh chiến đấu.
                            </p>
                        </div>
                        ...
                        <div className='feature-card'>
                            ...
                            <p className='feature-description'>
                                Thử thách bản thân trước những yêu thú hung dữ, đoạt lấy nội đan quý giá để đột phá cảnh giới.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='realms-grid'>
                        {[
                            ...
                            <div key={realm.level} className='realm-card'>
                                <div className='realm-image' style={{ backgroundImage: `url("${realm.image}")` }}></div>
